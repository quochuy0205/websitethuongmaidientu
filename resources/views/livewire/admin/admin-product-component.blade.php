                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             <a href="{{route('admin.addproduct')}}" class="btn btn-success pull-right">Add News</a>
                         </div>
                         <div class="col-md-4">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach($products as $product)
                                 <tr>
                                <td>{{$product->id}}</td>
                                <td><img src="{{asset('assets/images/products/')}}/{{$product->image}}" style="width:60px;" alt="{{$product->name}}"></td>
                                <td>{{$product->name}}</td>
