                        ...
                        <div class="panel panel-default">
                            <div class="panel panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    @endif
                                    <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="editNews">
                                        <div class="form-group">
                                            <label for="" class="col-md-4 control-label">Name</label>
                                            <div class="col-md-4">
                                                <input type="text" placeholder="Tên Tin Tức" class="form-control input-md" wire:model="name">
                                                @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" placeholder="Định Danh Tin Tức" class="form-control input-md" wire:model="slug" wire:keyup="generateslug">
                                                @error('slug')
                                                <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
