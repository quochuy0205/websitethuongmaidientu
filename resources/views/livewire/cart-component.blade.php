    ...
    <div class=" main-content-area">
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                <p class="summary-info"><span class="title">Tax({{ config('cart.tax')}}%) ({{ Session::get('coupon')['code'] }}) </span><b class="index">${{ $taxAfterDiscount }}</b></p>

                <p class="summary-info"><span class="title">Total</span><b class="index">{{ $totalAfterDiscount }}$</b></p>
                @else
                <p class="summary-info"><span class="title">Disscount</span><b class="index">{{Cart::tax()}}$</b></p>
                <p class="summary-info"><span class="title">Shipping Method</span><b class="index">Free Shipping</b></p>
            ...
            <div class="checkout-info">
                ...
                <a class="link-to-shop" href="/shop">Continue Shpping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
            </div>
            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Clear Shopping Cart</a>
                <a class="btn btn-update" href="#">Update Cart</a>
            </div>
        </div>
        @else
            <div class="text-center" style="padding:30px 0;">
                ...
                <p>Shopping Now!</p>
                <a href="/shop" class="btn btn-success">Shopping</a>
            </div>
        @endif
        <div class="wrap-iten-in-cart">
